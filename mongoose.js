...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 50 && innerWidth >= 768) {
  ...
  } else if (window.pageYOffset < 50 && innerWidth >= 768) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 600 && innerWidth >= 768) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 300 && innerWidth >= 768) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 2549 && innerWidth >= 770) {
  ...
  } else if (window.pageYOffset < 2340 && innerWidth >= 770) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 1200 && innerWidth >= 770) {
  ...
  } else if (window.pageYOffset < 1200 && innerWidth >= 770) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 1750 && innerWidth >= 770) {
  ...
  } else if (window.pageYOffset < 1750 && innerWidth >= 770) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 2400 && innerWidth >= 770) {
  ...
  } else if (window.pageYOffset < 2400 && innerWidth >= 770) {
...
window.addEventListener('scroll', () => {
  ...
  if (window.pageYOffset >= 3000 && innerWidth >= 770) {
  ...
  } else if (window.pageYOffset < 3000 && innerWidth >= 770) {
...
tutups.addEventListener('click', () => {
  sertifs.classList.remove('profile-show');
});
